...
console.log(CafeteriaProducts, " articulos de COMIDAS");


  const Cafex = CafeteriaProducts?.filter((e) => e.attributes?.sub_categoria?.data?.id === 5);
  const Desayuno =CafeteriaProducts?.filter((e) => e.attributes?.sub_categoria?.data?.id === 6);
  const DELICATESSEN = CafeteriaProducts?.filter((e) => e.attributes?.sub_categoria?.data?.id === 7);
  console.log(DELICATESSEN, " delicatesens");
  const POSTRES = CafeteriaProducts?.filter((e) => e.attributes?.sub_categoria?.data?.id === 8);
    ...
    <div className="containerL">
      ...
      <div className="conteinerLC ">
        <div className="conteinerLB2 animate__animated  animate__zoomIn animate__faster">
          <img src="https://www.elcolectivo.com.ar/u/fotografias/m/2022/10/4/f768x1-87673_87800_174.jpg" alt="promo" id="1" />
