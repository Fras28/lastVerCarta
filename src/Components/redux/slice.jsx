...
export const dataSlice = createSlice({
  ...
  reducers: {
    ...
    filterGenre: (state, action) => {
      let auxMovies = state.copyallProducts;
      state.allProduct =
        action.payload === "all"
          ? state.copyallProduct
    ...
    searchBar: (state, action) => {
      state.allProduct = state.copyallProducts.filter(
        (e) =>
    ...
    favoriteallProducts: (state, action) => {
...
export const asyncFavList = () => {
  return async function (dispatch) {
    try {
      ...
      return dispatch(favoriteallProducts(response.data));
    } catch (error) {}
  };
};
//--------------------------------------------------------------------------------------------------------------------
