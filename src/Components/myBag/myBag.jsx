...
export const Bag = (id) => {
  console.log(id.match.params.id, "ideeeeeeeeeeeeeeeeeee");
...
let result = favProd.filter((item,index)=>{
  ...
  return (
    <div className="backBag">
      ...
      {id.match.params.id < 0 || id.match.params.id > 20  || id.match.params.id === "undefined" || id.match.params.id === "sinMesa"? (
        ...
        <a
          href={`http://wa.me/542915729501?text=Hola Franco Mensaje de mi pedido ➤ ${favProd.map(
            (e) => e.name + "$" + e.price + ", "
          )} Total = $ ${total} , estamos en la mesa ${id.match.params.id}`}
          rel="noreferrer"
          target="_blank"
        >
