...
import BuyItemButton from "../Mp/mp";
    ...
    <div className="backBag   ">
      ...
      {isNaN(id.match.params.id) === true? (
        ...
        <div className="wsspTarj">
          {/* <BuyItemButton id={"7754614519107866"}/> */}
        {/* <select 
        className="selectP"
        onChange={metodoPago}
        value={pago.payment}
        >
         ...
         <a
          ...
          target="_blank"
        > 
          <button className="btnWssp">Enviar Pedido <svg width="16" height="16" viewBox="0 0 665 660" fill="none" xmlns="http://www.w3.org/2000/svg">
